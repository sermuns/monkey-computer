...
ARCHITECTURE func OF CPU_ent IS
  -- Microcode memory
  -- 000_000_0000_0_0000_00000000
  -- TB  FB  ALU  P SEQ  uADR
  SIGNAL micro_instr : unsigned(23 DOWNTO 0);
  ...
  ALIAS SEQ : unsigned(3 DOWNTO 0) IS micro_instr(12 DOWNTO 8);
  ALIAS micro_ADR : unsigned(7 DOWNTO 0) IS micro_instr(7 DOWNTO 0);

  -- Main memory: program, heap and stack
  SIGNAL PM : unsigned(23 DOWNTO 0);

  -- Instruction register
  SIGNAL IR : unsigned (23 DOWNTO 0); -- EX. "00000_000_00_0000000000000" => "OP_GRx_M_ADR"
  -- Field of the assembly instruction
  ALIAS assembly_OP : unsigned(4 DOWNTO 0) IS IR(23 DOWNTO 19);
  ALIAS assembly_GRx : unsigned(2 DOWNTO 0) IS IR(18 DOWNTO 16);
  ALIAS assembly_M : unsigned(2 DOWNTO 0) IS IR(15 DOWNTO 14);
  ALIAS assembly_ADR : unsigned(8 DOWNTO 0) IS IR(13 DOWNTO 0);
